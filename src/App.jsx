  ...
  if (jobFinished)
    return (
      <div className="App flex gap-8">
        <div className="bg-[#3955f6] hidden md:block text-white m-4 rounded-lg p-10 max-w-xs">
        ...
        <div className="mt-4 mx-auto md:mx-0 w-96">
          ...
          <p className="text-sm text-gray-500">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="underline font-bold text-[#3955f6]"
            >
              Cyrus Guest
            </a>
          </p>
          ...
          <button
            className="rounded-lg w-full shadow-lg p-3 mt-1 bg-[#3955f6] text-white font-bold hover:bg-white hover:text-[#3955f6] transition-all duration-200"
            onClick={openCSV}
          >
            View results
          </button>
      ...
      <div className="mt-4 mx-auto md:mx-0 w-96">
        ...
        {loading ? (
          ...
          <form className="flex flex-col max-w-md mt-4 md:mx-auto">
            ...
            <input
              className="outline-none placeholder-white border-none shadow-lg rounded-lg p-2 mt-1 text-white bg-[#3955f6] focus:bg-white focus:text-[#3955f6] focus:placeholder-[#3955f6] transition-all duration-200"
              type="text"
              placeholder="API Key"
            ...
            <label className="font-bold mt-8" htmlFor="export">
              Output directory:{" "}
              <span className="truncate text-[#3955f6] font-normal">
                {directoryPath}
              </span>
            </label>
            <button
              className="rounded-lg p-3 mt-1 shadow-lg bg-[#3955f6] text-white font-bold hover:bg-white hover:text-[#3955f6] transition-all duration-200"
            ...
            <button
              className="shadow-lg font-bold rounded-lg p-3 mt-5 bg-[#3955f6] text-white hover:bg-white hover:text-[#3955f6] transition-all duration-200"
              type="submit"
