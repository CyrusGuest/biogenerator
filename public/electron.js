...
const generateBio = async (doctor, openai, event) => {
  ...
  Write a warm and short (1-3 sentences) bio. Use weights (1-10) to guide the content. The bio should reflect the voice guidance provided above.
  YOU ARE CONSTRICTED TO SIMPLY THE INFORMATION PROVIDED ABOVE. YOU CANNOT INCLUDE ANY INFORMATION THAT IS NOT INCLUDED ABOVE. USE GENDER NEUTRAL PRONOUNS LIKE THEY/THEM.
  `;
